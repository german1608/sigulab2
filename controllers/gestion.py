...
# Función para corregir nombres en la columna
# "Responsable" de la bitácora
def limpia_responsables(texto):
        ...
        # Para cada match, se trae el valor en el dict
...
def bitacora_general():
    ...
    for elm in entradas_query:
        ...
        entradas.append({
            ...
            'responsable': limpia_responsables(responsable.first_name) + " " + responsable.last_name
        })
